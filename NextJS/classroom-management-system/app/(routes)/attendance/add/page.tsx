    ...
    return (
        <>
            <div>
                ...
                <div className="mt-8">
                    <form className="max-w-md mx-auto" onSubmit={submitAttendance}>
                        ...
                        <button type="submit" className="text-black bg-brand cursor-pointer box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">Submit</button>
                    </form>
                </div>
            </div>
        </>
