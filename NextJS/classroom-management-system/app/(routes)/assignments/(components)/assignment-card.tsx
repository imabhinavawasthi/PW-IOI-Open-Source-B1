...
export default function AssignmentCard(
    ...
    return (
        <>
            <Link href={`/assignments/${assignmentId}`} className="group relative block h-64 sm:h-80 lg:h-96">
                ...
                >
                    <div
                        className="px-4 pb-4 transition-opacity group-hover:absolute group-hover:opacity-0 sm:px-6 sm:pb-4 lg:px-8 lg:pb-8"
                    >
                        <svg
                            aria-hidden="true"
